...
flags.DEFINE_string("data_dir", "E:/code/dataset/", "Root directory of dataset [data]")
flags.DEFINE_string("sample_dir", "samplesnew", "Directory name to save the image samples [samples]")
